 ...
 */
@Slf4j
@Component("Zmn100InternalAddon")
public class Zmn100InternalAddon extends BaseAddon {

    @Getter
    private final ComponentTypeEnum addonType = ComponentTypeEnum.INTERNAL_ADDON;

    @Getter
    private final String addonId = "zmn";

    @Getter
    private final String addonVersion = "1.0.0";

    @Getter
    private final String addonLabel = "Internal-Zmn Addon";

    @Getter
    private final String addonDescription = "Internal-Zmn Addon";
