...
class TCron extends React.Component {
    ...
    return (
      <div className="biz-tCron">
        <Tabs>
          ...
          >
            <RadioGroup
              onChange={(e) => this.setState({ second: { ...second, cronEvery: e.target.value } })}
              value={second.cronEvery}
            >
              ...
              <Radio style={radioStyle} value="2">
                {text.Seconds.interval(
                  <InputNumber
                    ...
                    onChange={(v) =>
                      this.setState({ second: { ...second, incrementIncrement: v || 0 } })
                    }
                  />,
                  <InputNumber
                    size="small"
                    ...
                    max={59}
                    onChange={(v) =>
                      this.setState({ second: { ...second, incrementStart: v || 0 } })
                    }
                  />,
                )}
              </Radio>
              ...
              <Radio style={radioStyle} value="4">
                ...
                <div style={{ marginLeft: 24 }}>
                  {_.range(0, 10).map(this.renderSecondCheckbox.bind(this))}
                </div>
                <div style={{ marginLeft: 24 }}>
                  {_.range(10, 20).map(this.renderSecondCheckbox.bind(this))}
                </div>
                <div style={{ marginLeft: 24 }}>
                  {_.range(20, 30).map(this.renderSecondCheckbox.bind(this))}
                </div>
                <div style={{ marginLeft: 24 }}>
                  {_.range(30, 40).map(this.renderSecondCheckbox.bind(this))}
                </div>
                <div style={{ marginLeft: 24 }}>
                  {_.range(40, 50).map(this.renderSecondCheckbox.bind(this))}
                </div>
                <div style={{ marginLeft: 24 }}>
                  {_.range(50, 60).map(this.renderSecondCheckbox.bind(this))}
                </div>
              </Radio>
            </RadioGroup>
          </TabPane>
          ...
          >
            <RadioGroup
              onChange={(e) => this.setState({ minute: { ...minute, cronEvery: e.target.value } })}
              value={minute.cronEvery}
            >
              <Radio style={radioStyle} value="1">
                {text.Minutes.every}
              </Radio>
              <Radio style={radioStyle} value="2">
                {text.Minutes.interval(
                  <InputNumber
                    ...
                    onChange={(v) =>
                      this.setState({ minute: { ...minute, incrementIncrement: v || 0 } })
                    }
                  />,
                  <InputNumber
                    size="small"
                    ...
                    max={59}
                    onChange={(v) =>
                      this.setState({ minute: { ...minute, incrementStart: v || 0 } })
                    }
                  />,
                )}
              </Radio>
              ...
              <Radio style={radioStyle} value="4">
                ...
                <div style={{ marginLeft: 24 }}>
                  {_.range(0, 10).map(this.renderMinuteCheckbox.bind(this))}
                </div>
                <div style={{ marginLeft: 24 }}>
                  {_.range(10, 20).map(this.renderMinuteCheckbox.bind(this))}
                </div>
                <div style={{ marginLeft: 24 }}>
                  {_.range(20, 30).map(this.renderMinuteCheckbox.bind(this))}
                </div>
                <div style={{ marginLeft: 24 }}>
                  {_.range(30, 40).map(this.renderMinuteCheckbox.bind(this))}
                </div>
                <div style={{ marginLeft: 24 }}>
                  {_.range(40, 50).map(this.renderMinuteCheckbox.bind(this))}
                </div>
                <div style={{ marginLeft: 24 }}>
                  {_.range(50, 60).map(this.renderMinuteCheckbox.bind(this))}
                </div>
              </Radio>
            </RadioGroup>
          </TabPane>
          ...
          >
            <RadioGroup
              onChange={(e) => this.setState({ hour: { ...hour, cronEvery: e.target.value } })}
              value={hour.cronEvery}
            >
              <Radio style={radioStyle} value="1">
                {text.Hours.every}
              </Radio>
              <Radio style={radioStyle} value="2">
                {text.Hours.interval(
                  <InputNumber
                    ...
                    onChange={(v) =>
                      this.setState({ hour: { ...hour, incrementIncrement: v || 0 } })
                    }
                  />,
                  <InputNumber
                    size="small"
              ...
              <Radio style={radioStyle} value="4">
                {text.Hours.specific}
                <div style={{ marginLeft: 24 }}>
                  {_.range(0, 8).map(this.renderHourCheckbox.bind(this))}
                </div>
                <div style={{ marginLeft: 24 }}>
                  {_.range(8, 16).map(this.renderHourCheckbox.bind(this))}
                </div>
                <div style={{ marginLeft: 24 }}>
                  {_.range(16, 24).map(this.renderHourCheckbox.bind(this))}
                </div>
              </Radio>
            </RadioGroup>
          </TabPane>
          ...
          >
            <RadioGroup
              onChange={(e) => this.setState({ day: { ...day, cronEvery: e.target.value } })}
              value={day.cronEvery}
            >
              <Radio style={radioStyle} value="1">
                {text.Day.every}
              ...
              <Radio style={radioStyle} value="2">
                {text.Day.intervalWeek(
                  <InputNumber
                    ...
                    onChange={(v) =>
                      this.setState({ week: { ...week, incrementIncrement: v || 0 } })
                    }
                  />,
                  <Select
                    size="small"
                    value={week.incrementStart}
                    onChange={(v) => this.setState({ week: { ...week, incrementStart: v } })}
                  >
                    {_.range(1, 8).map((i) => (
              ...
              <Radio style={{ ...radioStyle, height: 80 }} value="4">
                ...
                <div style={{ marginLeft: 24 }}>
                  {_.range(0, 7).map(this.renderWeekCheckbox.bind(this))}
                </div>
              </Radio>
              <Radio style={{ ...radioStyle, height: 160 }} value="5">
                {text.Day.specificDay}
                <div style={{ marginLeft: 24 }}>
                  {_.range(1, 12).map(this.renderDayCheckbox.bind(this))}
                </div>
                <div style={{ marginLeft: 24 }}>
                  {_.range(12, 23).map(this.renderDayCheckbox.bind(this))}
                </div>
                <div style={{ marginLeft: 24 }}>
                  {_.range(23, 32).map(this.renderDayCheckbox.bind(this))}
                </div>
              </Radio>
              ...
              <Radio style={radioStyle} value="8">
                {text.Day.lastWeek(
                  <Select
                    size="small"
                    value={day.cronLastSpecificDomDay}
                    onChange={(v) => this.setState({ day: { ...day, cronLastSpecificDomDay: v } })}
                  >
                    {_.range(1, 8).map((i) => (
                      <Option key={i} value={i}>
                        {text.Week[i - 1]}
              ...
              <Radio style={radioStyle} value="9">
                {text.Day.beforeEndMonth(
                  <InputNumber
                    ...
                    onChange={(v) =>
                      this.setState({ day: { ...day, cronDaysBeforeEomMinus: v || 0 } })
                    }
                  />,
                )}
              </Radio>
              <Radio style={radioStyle} value="10">
                {text.Day.nearestWeekday(
                  <InputNumber
                    ...
                    onChange={(v) =>
                      this.setState({ day: { ...day, cronDaysNearestWeekday: v || 0 } })
                    }
                  />,
                )}
              </Radio>
              <Radio style={radioStyle} value="11">
                {text.Day.someWeekday(
                  ...
                  <Select
                    size="small"
                    value={week.cronNthDayDay}
                    onChange={(v) => this.setState({ week: { ...week, cronNthDayDay: v } })}
                  >
                    {_.range(1, 8).map((i) => (
                      <Option key={i} value={i}>
                        {text.Week[i - 1]}
          ...
          >
            <RadioGroup
              onChange={(e) => this.setState({ month: { ...month, cronEvery: e.target.value } })}
              value={month.cronEvery}
            >
              <Radio style={radioStyle} value="1">
                {text.Month.every}
              </Radio>
              <Radio style={radioStyle} value="2">
                {text.Month.interval(
                  <InputNumber
                    ...
                    onChange={(v) =>
                      this.setState({ month: { ...month, incrementIncrement: v || 0 } })
                    }
                  />,
                  <InputNumber
                    size="small"
              ...
              <Radio style={radioStyle} value="4">
                {text.Month.specific}
                <div style={{ marginLeft: 24 }}>
                  {_.range(1, 7).map(this.renderMonthCheckbox.bind(this))}
                </div>
                <div style={{ marginLeft: 24 }}>
                  {_.range(7, 13).map(this.renderMonthCheckbox.bind(this))}
                </div>
              </Radio>
            </RadioGroup>
          </TabPane>
          ...
          >
            <RadioGroup
              onChange={(e) => this.setState({ year: { ...year, cronEvery: e.target.value } })}
              value={year.cronEvery}
            >
              <Radio style={radioStyle} value="1">
                {text.Year.every}
              </Radio>
              <Radio style={radioStyle} value="2">
                {text.Year.interval(
                  <InputNumber
                    ...
                    onChange={(v) =>
                      this.setState({ year: { ...year, incrementIncrement: v || 0 } })
                    }
                  />,
                  <InputNumber
                    size="small"
              ...
              <Radio style={radioStyle} value="4">
                {text.Year.specific}
                <div style={{ marginLeft: 24 }}>
                  {_.range(2018, 2026).map(this.renderYearCheckbox.bind(this))}
                </div>
                <div style={{ marginLeft: 24 }}>
                  {_.range(2026, 2034).map(this.renderYearCheckbox.bind(this))}
                </div>
              </Radio>
            </RadioGroup>
          </TabPane>
    ...
    const onCheck = (checked) => {
      if (checked) {
        this.setState({
          second: {
            ...second,
            specificSpecific: second.specificSpecific.concat([sec]),
            cronEvery: '4',
          },
        })
      } else {
        this.setState({
          second: {
            ...second,
            specificSpecific: second.specificSpecific.filter((n) => n !== sec),
            cronEvery: '4',
          },
        })
      }
    ...
    const onCheck = (checked) => {
      if (checked) {
        this.setState({
          minute: {
            ...minute,
            specificSpecific: minute.specificSpecific.concat([min]),
            cronEvery: '4',
          },
        })
      } else {
        this.setState({
          minute: {
            ...minute,
            specificSpecific: minute.specificSpecific.filter((n) => n !== min),
            cronEvery: '4',
          },
        })
      }
  ...
  renderHourCheckbox(h) {
    ...
    const onCheck = (checked) => {
      if (checked) {
        this.setState({
          hour: { ...hour, specificSpecific: hour.specificSpecific.concat([h]), cronEvery: '4' },
        })
      } else {
        this.setState({
          hour: {
            ...hour,
            specificSpecific: hour.specificSpecific.filter((n) => n !== h),
            cronEvery: '4',
          },
        })
      }
  ...
  renderWeekCheckbox(wk) {
    ...
    const onCheck = (checked) => {
      if (checked) {
        this.setState({
          week: { ...week, specificSpecific: week.specificSpecific.concat([weekArray[wk]]) },
          day: { ...day, cronEvery: '4' },
        })
      } else {
        this.setState({
          week: {
            ...week,
            specificSpecific: week.specificSpecific.filter((n) => n !== weekArray[wk]),
          },
          day: { ...day, cronEvery: '4' },
        })
      }
  ...
  renderDayCheckbox(d) {
    ...
    const onCheck = (checked) => {
      if (checked) {
        this.setState({
          day: { ...day, specificSpecific: day.specificSpecific.concat([d]), cronEvery: '5' },
        })
      } else {
        this.setState({
          day: {
            ...day,
            specificSpecific: day.specificSpecific.filter((n) => n !== d),
            cronEvery: '5',
          },
        })
      }
    ...
    const onCheck = (checked) => {
      if (checked) {
        this.setState({
          month: {
            ...month,
            specificSpecific: month.specificSpecific.concat([mon]),
            cronEvery: '4',
          },
        })
      } else {
        this.setState({
          month: {
            ...month,
            specificSpecific: month.specificSpecific.filter((n) => n !== mon),
            cronEvery: '4',
          },
        })
      }
  ...
  renderYearCheckbox(y) {
    ...
    const onCheck = (checked) => {
      if (checked) {
        this.setState({
          year: { ...year, specificSpecific: year.specificSpecific.concat([y]), cronEvery: '4' },
        })
      } else {
        this.setState({
          year: {
            ...year,
            specificSpecific: year.specificSpecific.filter((n) => n !== y),
            cronEvery: '4',
          },
        })
      }
