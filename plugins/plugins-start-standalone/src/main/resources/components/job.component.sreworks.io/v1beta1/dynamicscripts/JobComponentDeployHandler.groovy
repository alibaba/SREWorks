 ...
 */
class JobComponentDeployHandler implements DeployComponentHandler {

    private static final Logger log = LoggerFactory.getLogger(JobComponentDeployHandler.class)
     ...
     */
    public static final String NAME = "job.component.sreworks.io/v1beta1/deploy"
    ...
    LaunchDeployComponentHandlerRes launch(LaunchDeployComponentHandlerReq request) {
        ...
        streamLogService.info(streamKey, "start execute JobComponentDeployHandler")
        ...
        LaunchDeployComponentHandlerRes res = LaunchDeployComponentHandlerRes.builder()
                ...
                .build()
        streamLogService.info(streamKey, "execute JobComponentDeployHandler finish!")
        return res
    }
