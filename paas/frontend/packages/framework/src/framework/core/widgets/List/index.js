...
import { List, Avatar, Popover, Pagination } from 'antd'
  ...
  render() {
    ...
    return (
      <div style={{ width: '100%', minHeight }}>
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  style={{ width: `calc(100% - ${widgetConfig.width || '300px'})` }}
                >
                  {columns &&
                    !!columns.length &&
                    columns.map((column) => {
                      if (column.render && typeof column.render === 'string') {
                        return (
                          <JSXRender
                            ...
                            jsx={util.renderTemplateString(column.render)}
                          />
                        )
                      } else {
                        return (
                          <div
                            key={column.dataIndex}
                            className={column.width ? 'description-width' : 'description-wrap'}
                          ...
                          {item[column.dataIndex] || '-'}
                                ...
                                {column.isLink ? (
                                  <a href={'#/' + item[column.dataIndex]} target="_blank">
                                    {item[column.dataIndex]}
                                  </a>
                                ) : (
                                  <Popover content={item[column.dataIndex] || '-'}>
        ...
        />
        {widgetConfig.dataSourceMeta && widgetConfig.dataSourceMeta.paging && (
          <Pagination
