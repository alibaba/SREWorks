...
public class K8sMicroserviceComponenPackage implements ComponentPackageBase, ApplicationListener<KanikoPodEvent> {
                            ...
                            if (taskPodMap.get(taskId).size() == succeedPodMap.get(taskId).size()) {
                                ...
                                for (String runPod : taskPodMap.get(taskId)) {
                                    try {
                                        ...
                                        log.warn("action=KanikoSucceedOp||can not read kaniko pod log:{}", runPod);
                                    }
                                    try {
