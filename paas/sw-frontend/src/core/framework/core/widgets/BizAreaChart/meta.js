export default {
    ...
    "info": {
      ...
      "description": "bizCharts图表库面积图",
      "links": [],
      "logos": {
        "large": "",
        "small": require("./icon.svg"),
        "fontClass":"BizAreaChart"
      },
      "build": {
        "time": "",
        "repo": "",
      ...
      "updated": "",
      "version": "",
      "docs": "<a target='_blank' href='https://bizcharts.taobao.com/product/BizCharts4/category/77/page/118'>组件文档地址</a>",
    },
    "state": "",
    "latestVersion": "1.0",
    "configSchema": {
