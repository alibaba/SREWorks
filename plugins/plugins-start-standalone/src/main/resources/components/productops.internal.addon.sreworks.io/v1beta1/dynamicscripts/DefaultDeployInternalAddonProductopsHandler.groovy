...
class DefaultDeployInternalAddonProductopsHandler implements DeployComponentHandler {
     ...
     * 当前内置 Handler 名称
     */
    public static final String NAME = "productops.internal.addon.sreworks.io/v1beta1/deploy"
    ...
    private static void reportSingleAppTreeToElasticsearch(
        ...
        while (true) {
            def urlPrefix
            if ("Internal" == System.getenv("CLOUD_TYPE") || "OXS" == System.getenv("CLOUD_TYPE")) {
                urlPrefix = String.format("%s/jobs/report_app_tree_structures/%s/asyncStart", endpoint, appTreeId)
            } else {
