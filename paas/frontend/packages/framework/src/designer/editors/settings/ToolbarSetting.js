      ...
      items: [
        {
          ...
          name: 'customRender',
          initValue: customRender,
          required: false,
          label: 'JSX模板',
          tooltip:
            '填写标准的JSX,支持变量占位;支持antd组件、内置render组件,引用方式<antd.xxx>,<common.xxx>',
          layout: {
            span: 24,
          },
        },
