...
public abstract class RuleManagerFactory {
    protected Map<String, EmonRulesManager> rulesManagers;
     ...
     * @return
     */
    public EmonRulesManager getRuleManager(String tenant) {
        EmonRulesManager rulesManager = null;
     ...
     * @return
     */
    public EmonRulesManager getRuleManager() {
        EmonRulesManager rulesManager = null;
        if (rulesManagers != null && !rulesManagers.isEmpty()) {
    ...
    public void close() {
        if (this.rulesManagers != null) {
            rulesManagers.values().forEach(EmonRulesManager::stopUpdateTiming);
        }
    }

    public Map<String, EmonRulesManager> getRulesManagers() {
