...
class flyAdminService {
  ...
  getApplicationVersion(params) {
    return httpClient.get(
      `gateway/v2/foundation/appmanager/apps/${params.appId}/app-packages/latest-version`,
      { params: params },
    )
  }

  getApplicationServiceList(params) {
    return httpClient.get(`gateway/v2/foundation/appmanager/apps/${params.appId}/components`, {
      params: params,
    })
  }
  ...
  getListDataOutputs(params) {
    return httpClient.get(
      `gateway/v2/foundation/appmanager/apps/${params.appId}/addon/${params.addonName}/data-outputs`,
      { params: params },
    )
  }
  ...
  getListComponentVersions(params) {
    return httpClient.get(
      `gateway/v2/foundation/appmanager/apps/${params.appId}/component-packages/${params.componentType}/${params.componentName}/latest-version`,
      { params: params },
    )
  }
  ...
  getMicroservice(params) {
    return httpClient.get(
      `gateway/v2/foundation/appmanager/apps/${params.appId}/k8s-microservices/${params.id}`,
      { params: params },
    )
  }
  ...
  getStageList(params) {
    return httpClient.get(
      `gateway/v2/foundation/appmanager/namespaces/${
        util.getUrlParams().namespaceId || properties.defaultNamespace
      }/stages`,
      {
        ...getHeader(),
        params: params,
  ...
  postPackage(params) {
    return httpClient.post(
      `gateway/v2/foundation/appmanager/apps/${params.appId}/app-package-tasks`,
      params,
    )
  }
  ...
  postMicroservice(params) {
    return httpClient.post(
      `gateway/v2/foundation/appmanager/apps/${params.appId}/k8s-microservices`,
      params,
    )
  }
  ...
  putAddon(params) {
    return httpClient.put(
      `gateway/v2/foundation/appmanager/apps/${params.appId}/addon/${params.addonName}`,
      params,
    )
  }
  ...
  postVarEnv(params, appId) {
    return httpClient.put(
      `gateway/v2/foundation/appmanager/apps/${appId}/variables?type=env`,
      params,
    )
  }
  ...
  getPackageTaskDetail(params) {
    return httpClient.get(
      `gateway/v2/foundation/appmanager/apps/${params.appId}/app-package-tasks/${params.taskId}`,
      { params: params },
    )
  }
  ...
  postDeploy(yaml, autoEnvironment) {
    return httpClient.post(
      'gateway/v2/foundation/appmanager/deployments/launch?autoEnvironment=' + autoEnvironment,
      yaml,
  ...
  postPermission(roleId, params) {
    return httpClient.post(
      `gateway/v2/common/authProxy/roles/${roleId}/permissions/${params.permissionId}`,
      params,
      {
        headers: {
          'X-Biz-App': util.getNewBizApp(),
  ...
  deletePermission(roleId, permissionId) {
    return httpClient.delete(
      `gateway/v2/common/authProxy/roles/${roleId}/permissions/${permissionId}`,
      null,
      {
        headers: {
          'X-Biz-App': util.getNewBizApp(),
