...
class ScriptComponentHandler implements ComponentHandler {
    ...
    public static final String NAME = "script.component.sreworks.io/v1beta1"
    ...
    String buildScriptName() {
        return "script.component.sreworks.io/v1beta1/build"
    }
    ...
    String deployScriptName() {
        return "script.component.sreworks.io/v1beta1/deploy"
    }
    ...
    @Override
    String destroyName() {
        return "script.component.sreworks.io/v1beta1/destroy"
    }
    ...
    String watchScriptName() {
        return "script.component.sreworks.io/v1beta1/watch"
    }
}
