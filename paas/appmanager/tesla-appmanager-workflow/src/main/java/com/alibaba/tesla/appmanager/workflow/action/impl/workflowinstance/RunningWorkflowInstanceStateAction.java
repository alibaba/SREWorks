...
@Slf4j
@Service("RunningWorkflowInstanceStateAction")
public class RunningWorkflowInstanceStateAction implements WorkflowInstanceStateAction, ApplicationRunner {

    private static final WorkflowInstanceStateEnum STATE = WorkflowInstanceStateEnum.RUNNING;
