...
public class MinioClientTest {
    ...
    public void testCreateBucket() throws Exception {
        String bucketName = "metric-rules";
        MinioClient minioClient = MinioClient.builder().endpoint(minioConfig.getEndpoint()).credentials(minioConfig.getAccessKey(), minioConfig.getSecretKey()).build();
    ...
    public void testCreateObject() throws Exception {
        ...
        minioClient.uploadObject(UploadObjectArgs.builder().bucket(minioConfig.getBucket()).object("sreworks/rules.json").filename("/Users/metric-flink/metric-alarm/src/test/resources/rules.json").build());
    }
