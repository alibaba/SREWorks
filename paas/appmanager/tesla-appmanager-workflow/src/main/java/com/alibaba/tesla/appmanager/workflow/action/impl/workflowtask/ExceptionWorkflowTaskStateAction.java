...
@Slf4j
@Service("ExceptionWorkflowTaskStateAction")
public class ExceptionWorkflowTaskStateAction implements WorkflowTaskStateAction, ApplicationRunner {

    private static final WorkflowTaskStateEnum STATE = WorkflowTaskStateEnum.EXCEPTION;
