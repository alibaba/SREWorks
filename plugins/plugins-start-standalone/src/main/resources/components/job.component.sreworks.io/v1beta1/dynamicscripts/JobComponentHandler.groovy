...
class JobComponentHandler implements ComponentHandler {
    ...
    public static final String NAME = "job.component.sreworks.io/v1beta1"
    ...
    String buildScriptName() {
        return "job.component.sreworks.io/v1beta1/build"
    }
    ...
    String deployScriptName() {
        return "job.component.sreworks.io/v1beta1/deploy"
    }
    ...
    @Override
    String destroyName() {
        return "job.component.sreworks.io/v1beta1/destroy"
    }
    ...
    String watchScriptName() {
        return "job.component.sreworks.io/v1beta1/watch"
    }
}
