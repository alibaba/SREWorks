...
/**
 * 默认 AppBinding Internal Addon Groovy Handler
 *
 * @author yaoxing.gyx@alibaba-inc.com
 */
class DefaultBuildInternalAddonAppBindingHandler implements BuildComponentHandler {

    private static final Logger log = LoggerFactory.getLogger(DefaultBuildInternalAddonAppBindingHandler.class)
     ...
     * 当前内置 Handler 名称
     */
    public static final String NAME = "app.binding.internal.addon.sreworks.io/v1beta1/build"
    ...
    private static final String TEMPLATE_INTERNAL_ADDON_APPBINDING_FILENAME = "default_internal_addon_appbinding.tpl"
    ...
    LaunchBuildComponentHandlerRes launch(BuildComponentHandlerReq request) {
        ...
        def template = getTemplate(TEMPLATE_INTERNAL_ADDON_APPBINDING_FILENAME)
