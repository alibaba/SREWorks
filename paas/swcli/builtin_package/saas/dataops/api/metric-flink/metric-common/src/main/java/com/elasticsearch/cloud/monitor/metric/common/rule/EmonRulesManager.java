...
import com.elasticsearch.cloud.monitor.commons.event.Event;
import com.elasticsearch.cloud.monitor.commons.rule.*;
import com.elasticsearch.cloud.monitor.commons.rule.compose.Monitor;
 ...
 */
@Slf4j
public abstract class EmonRulesManager extends SreworksRulesManager{
    ...
    public EmonRulesManager(Object clientConfig, RulesLoader loader) {
        if (loader != null) {
            this.loader = loader;
        } else {
...
//        String versionFile = FileUtils.getFileDir(ruleFileOrDir) + "/version";
