...
/**
 * Tianji ProductOps Addon
 *
 * @author yaoxing.gyx@alibaba-inc.com
 */
@Slf4j
@Component("TianjiProductops100InternalAddon")
public class TianjiProductops100InternalAddon extends BaseAddon {

    @Getter
    private final String addonType = ComponentTypeEnum.INTERNAL_ADDON.toString();

    @Getter
    private final String addonId = "tianji_productops";

    @Getter
    private final String addonVersion = "1.0.0";

    @Getter
    private final String addonLabel = "tianji-productops Addon";

    @Getter
    private final String addonDescription = "tianji-productops Addon";
