 ...
 */
@Slf4j
@Component("Checkmonitor100InternalAddon")
public class Checkmonitor100InternalAddon extends BaseAddon {
    ...
    @Getter
    private final String addonLabel = "Internal-CheckMonitor Addon";

    @Getter
    private final String addonDescription = "Internal-CheckMonitor Addon";
