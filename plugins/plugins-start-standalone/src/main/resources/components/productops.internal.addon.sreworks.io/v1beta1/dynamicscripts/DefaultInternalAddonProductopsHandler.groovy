 ...
 */
class DefaultInternalAddonProductopsHandler implements ComponentHandler {

    /**
     * Handler 元信息
     */
    public static final String KIND = "COMPONENT"
    public static final String NAME = "productops.internal.addon.sreworks.io/v1beta1"
    ...
    String buildScriptName() {
        return "productops.internal.addon.sreworks.io/v1beta1/build"
    }
    ...
    String deployScriptName() {
        return "productops.internal.addon.sreworks.io/v1beta1/deploy"
    }
