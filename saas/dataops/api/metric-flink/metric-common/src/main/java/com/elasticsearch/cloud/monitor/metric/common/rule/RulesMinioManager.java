 ...
 */
@Slf4j
public class RulesMinioManager extends EmonRulesManager {

    private MinioConfig minioConfig;

    public RulesMinioManager(MinioConfig minioConfig) {
        this(minioConfig,null);
    }

    public RulesMinioManager(MinioConfig minioConfig, RulesLoader loader) {
