...
public class AppPackageService {
    ...
    public void start(Long appId, Long teamRegistryId, Long teamRepoId, String version, String user)
        throws IOException, ApiException {

        JSONObject startRet = flyadminAppmanagerPackageService.start(
            appId, teamRegistryId, teamRepoId, version, user);
