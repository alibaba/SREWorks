 ...
 */
class DefaultResourceAddonHandler implements ComponentHandler {

    /**
     * Handler 元信息
     */
    public static final String KIND = "COMPONENT"
    public static final String NAME = "resource.internal.addon.sreworks.io/v1beta1"
    ...
    String buildScriptName() {
        return "resource.internal.addon.sreworks.io/v1beta1/build"
    }
    ...
    String deployScriptName() {
        return "resource.internal.addon.sreworks.io/v1beta1/deploy"
    }
