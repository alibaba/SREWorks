 ...
 */
class DefaultBuildInternalAddonProductopsHandler implements BuildComponentHandler {

    private static final Logger log = LoggerFactory.getLogger(DefaultBuildInternalAddonProductopsHandler.class)
     ...
     * 当前内置 Handler 名称
     */
    public static final String NAME = "productops.internal.addon.sreworks.io/v1beta1/build"
