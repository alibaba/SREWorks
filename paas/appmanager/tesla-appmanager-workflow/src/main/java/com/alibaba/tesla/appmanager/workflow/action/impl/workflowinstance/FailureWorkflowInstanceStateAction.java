...
@Slf4j
@Service("FailureWorkflowInstanceStateAction")
public class FailureWorkflowInstanceStateAction implements WorkflowInstanceStateAction, ApplicationRunner {

    private static final WorkflowInstanceStateEnum STATE = WorkflowInstanceStateEnum.FAILURE;
