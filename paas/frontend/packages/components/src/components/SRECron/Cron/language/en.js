...
export default {
  Seconds: {
    ...
    interval: (step, start) => (
      <span>
        Every {step} second(s), starting at {start} second
      </span>
    ),
    specific: 'Specific second (choose one or many)',
    cycle: (start, end) => (
      <span>
        Every second between second {start} and second {end}
      </span>
    ),
  },
  Minutes: {
    ...
    interval: (step, start) => (
      <span>
        Every {step} minute(s), starting at {start} minute
      </span>
    ),
    specific: 'Specific minute (choose one or many)',
    cycle: (start, end) => (
      <span>
        Every minute between minute {start} and minute {end}
      </span>
    ),
  },
  Hours: {
    ...
    interval: (step, start) => (
      <span>
        Every {step} hour(s), starting at {start} hour
      </span>
    ),
    specific: 'Specific hour (choose one or many)',
    cycle: (start, end) => (
      <span>
        Every minute between hour {start} and hour {end}
      </span>
    ),
  },
  Day: {
    name: 'Day',
    every: 'Every day',
    intervalWeek: (step, start) => (
      <span>
        Every {step} day(s) starting on {start}
      </span>
    ),
    intervalDay: (step, start) => (
      <span>
        Every {step} day(s) starting at the {start} of the month
      </span>
    ),
    ...
    nearestWeekday: (day) => (
      <span>Nearest weekday (Monday to Friday) to the {day} of the month</span>
    ),
    someWeekday: (nth, day) => (
      <span>
        On the {nth}th {day} of the month
      </span>
    ),
  },
  ...
  Month: {
    ...
    interval: (step, start) => (
      <span>
        Every {step} month(s) starting in {start}
      </span>
    ),
  ...
  Year: {
    ...
    interval: (step, start) => (
      <span>
        Every {step} year(s) starting in {start}
      </span>
    ),
    specific: 'Specific year (choose one or many)',
    cycle: (start, end) => (
      <span>
        Every year between {start} and {end}
      </span>
    ),
  },
  Save: 'Save',
