...
public class MicroServiceService {
    ...
    public JSONObject getService(AppInstance appInstance, AppComponentInstance appComponentInstance)
        ...
        V1Service service = api.readNamespacedService(
            msName(appInstance, appComponentInstance), appInstance.namespace(), null, null, null);
    ...
    public void metricOn(AppInstance appInstance, AppComponentInstance appComponentInstance)
        ...
        JSONArray patchArray = JsonUtil.list(JsonUtil.map(
            "op", "replace",
            "path", "/metadata/labels/sreworks",
            "value", "metric"
        ));
        V1Patch patch = new V1Patch(JSONObject.toJSONString(patchArray));
        api.patchNamespacedService(
            msName(appInstance, appComponentInstance), appInstance.namespace(), patch, null, null, null, null);
    }
