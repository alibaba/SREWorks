...
public enum DeployAppStateEnum {
    ...
    public boolean isError(){
        return this.equals(FAILURE) || this.equals(EXCEPTION) || this.equals(WAIT_FOR_OP) || this.equals(TERMINATED);
    }

    public boolean isFinalState() {
        return this.equals(SUCCESS) || this.equals(FAILURE) || this.equals(EXCEPTION)
                || this.equals(WAIT_FOR_OP) || this.equals(TERMINATED);
    }
}
