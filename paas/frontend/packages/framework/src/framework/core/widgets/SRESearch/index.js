  ...
  render() {
    ...
    return (
      <div
        ref={this.currentRef}
        style={{
          width: Number(widgetConfig.complength) || 540,
          margin: 'auto',
          padding: `${Number(widgetConfig.compPadding)}px 0` || '20px 0',
        }}
        className={classNames('biz-tSearch', this.props.className)}
      ...
      >
        ...
        <div
          style={{
            ...
            width: Number(widgetConfig.complength) - 2 || 540,
          }}
        ...
        >
          ...
          <div
            ...
            style={{ width: Number(widgetConfig.complength) - 2 || 540 }}
          >
            {hotKeyOptions &&
