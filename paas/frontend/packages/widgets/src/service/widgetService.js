...
class Service {
  ...
  updateNode(params) {
    ...
    return httpClient.put(`${productopsPrefix}/appTrees/structure?stageId=dev`, params, {
      ...getHeader(),
    })
  }
  ...
  insertNode(params) {
    ...
    return httpClient.post(`${productopsPrefix}/appTrees/structure?stageId=dev`, params, {
      ...getHeader(),
    })
  }
  ...
  getAppTables(params) {
    return httpClient.get(`gateway/v2/foundation/teslacmdb/entity/product/meta/getTables`, {
      params: params,
    })
  }

  getColumnList(params) {
    return httpClient.get(`gateway/v2/foundation/teslacmdb/entity/product/meta/getColumnList`, {
      params: params,
    })
  }
  ...
  getMainPage(nodeTypePath, stageId) {
    ...
    return httpClient
      .get(`${productopsPrefix}/nodeTypePaths/tabs`, {
        ...getHeader(),
        params,
      })
      .then((result) => {
  ...
  saveMainPage(tabData = {}) {
    if (properties.devFlag === 'dev') {
      httpClient.put(`${newPrefix}/nodeTypePaths/tab?stageId=dev`, tabData, { ...getHeader() })
    }
    return httpClient.put(`${productopsPrefix}/nodeTypePaths/tab?stageId=dev`, tabData, {
      ...getHeader(),
    })
  }
  ...
  getCustomList() {
    return httpClient.get(
      '/gateway/v2/foundation/frontend-service/frontend/component/list?stageId=prod',
    )
  }
  createFromTemplateByClone(params) {
    return httpClient.post(
      '/gateway/v2/foundation/frontend-service/frontend/appTrees/clone?stageId=dev',
      params,
    )
  }
}
