...
-- ES Endpoint init
-- ----------------------------
INSERT INTO `config` (`id`,`gmt_create`,`gmt_modified`,`category`,`nr_type`,`nr_id`,`name`,`modifier`,`content`) VALUES (10000,'2020-03-24 22:46:53','2020-04-03 00:57:40','__category','__nrType','__nrId','backendStores','sreworks','[{"schema":"http","default_store":true,"port":9200,"name":"backend_store_basic","host":"prod-dataops-elasticsearch-master.sreworks-dataops.svc.cluster.local","index_patterns":{},"type":"elasticsearch","backup_store":"backend_store_level_1"}]');
...
VALUES (1,'2021-09-29 09:51:13','2021-09-29 11:51:19','{{x-empid}}','{{x-empid}}','[[{"__type":"sreworks_productops_node","__id":"${id}","__gmt_create":"${gmt_create}","__gmt_modified":"${gmt_modified}","__label":"站点 导航 站点导航 前端","config":"${config}","node_type_path":"${node_type_path}","parent_node_type_path":"${parent_node_type_path}"}]]','{"startPeriod":0,"password":"bGuwsAWQM6K","port":3306,"isPartition":false,"host":"sreworks-mysql","interval":900,"db":"abm_paas_action","username":"root","sql":"select * from productops_node where stage_id=\'prod\' and config not like \'%detail%\';"}','mysqlTable','0','sreworks_productops_node','true','{}');

REPLACE INTO `consumer`(`id`,`gmt_create`,`gmt_modified`,`modifier`,`creator`,`import_config`,`source_info`,`source_type`,`offset`,`name`,`enable`,`user_import_config`)
VALUES (2,'2021-09-29 09:51:13','2021-09-29 11:51:19','{{x-empid}}','{{x-empid}}','[[{"__type":"sreworks_cluster","__id":"${id}","__gmt_create":"${gmt_create}","__gmt_modified":"${gmt_modified}","__label":"集群 集群实体","account_id":"${account_id}","cluster_name":"${cluster_name}","name":"${name}","team_id":"${team_id}","description":"${description}"}]]','{"startPeriod":0,"password":"bGuwsAWQM6K","port":3306,"isPartition":false,"host":"sreworks-mysql","interval":900,"db":"sreworks_meta","username":"root","sql":"select * from cluster;"}','mysqlTable','0','sreworks_cluster','true','{}');

REPLACE INTO `consumer`(`id`,`gmt_create`,`gmt_modified`,`modifier`,`creator`,`import_config`,`source_info`,`source_type`,`offset`,`name`,`enable`,`user_import_config`)
VALUES (3,'2021-09-29 09:51:13','2021-09-29 11:51:19','{{x-empid}}','{{x-empid}}','[[{"__type":"sreworks_team","__id":"${id}","__gmt_create":"${gmt_create}","__gmt_modified":"${gmt_modified}","name":"${name}","description":"${description}","avatar":"${avatar}","__label":"团队 团队实体"}]]','{"startPeriod":0,"password":"bGuwsAWQM6K","port":3306,"isPartition":false,"host":"sreworks-mysql","interval":900,"db":"sreworks_meta","username":"root","sql":"select * from team;"}','mysqlTable','0','sreworks_team','true','{}');

REPLACE INTO `consumer`(`id`,`gmt_create`,`gmt_modified`,`modifier`,`creator`,`import_config`,`source_info`,`source_type`,`offset`,`name`,`enable`,`user_import_config`)
VALUES (4,'2021-09-29 09:51:13','2021-09-29 11:51:19','{{x-empid}}','{{x-empid}}','[[{"__type":"sreworks_app","__id":"${id}","__gmt_create":"${gmt_create}","__gmt_modified":"${gmt_modified}","__label":"应用 应用实体","account_id":"${account_id}","name":"${name}","team_id":"${team_id}","labels":"${labels}","description":"${description}"}]]','{"startPeriod":0,"password":"bGuwsAWQM6K","port":3306,"isPartition":false,"host":"sreworks-mysql","interval":900,"db":"sreworks_meta","username":"root","sql":"select * from app;"}','mysqlTable','0','sreworks_app','true','{}');

REPLACE INTO `consumer`(`id`,`gmt_create`,`gmt_modified`,`modifier`,`creator`,`import_config`,`source_info`,`source_type`,`offset`,`name`,`enable`,`user_import_config`)
VALUES (5,'2021-09-29 09:51:13','2021-09-29 11:51:19','{{x-empid}}','{{x-empid}}','[[{"__type":"sreworks_event","__id":"${id}","__gmt_create":"${gmt_create}","__gmt_modified":"${gmt_modified}","__label":"应用事件","name":"${name}","app_id":"${app_id}","app_name":"${app_name}","app_component_name":"${app_component_name}","ex_config":"${ex_config}","description":"${description}"}]]','{"startPeriod":0,"password":"cb56b5is5e21_c359b42223","port":3306,"isPartition":false,"host":"prod-dataops-mysql.sreworks-dataops.svc.cluster.local","interval":900,"db":"sw_saas_health","username":"root","sql":"select * from common_definition where category=\'event\';"}','mysqlTable','0','sreworks_event','true','{}');

REPLACE INTO `consumer`(`id`,`gmt_create`,`gmt_modified`,`modifier`,`creator`,`import_config`,`source_info`,`source_type`,`offset`,`name`,`enable`,`user_import_config`)
VALUES (10,'2021-09-29 09:51:13','2021-09-29 11:51:19','{{x-empid}}','{{x-empid}}','[[{"__type":"sreworks_metric","__id":"${id}","__gmt_create":"${gmt_create}","__gmt_modified":"${gmt_modified}","__label":"可观测 指标","name":"${name}", "alias":"${alias}", "metric_type":"${type}","labels":"${labels}", "description":"${description}"}]]','{"startPeriod":0,"password":"cb56b5is5e21_c359b42223","port":3306,"isPartition":false,"host":"prod-dataops-mysql.sreworks-dataops.svc.cluster.local","interval":900,"db":"pmdb","username":"root","sql":"select * from metric;"}','mysqlTable','0','sreworks_metric','true','{}');

REPLACE INTO `consumer`(`id`,`gmt_create`,`gmt_modified`,`modifier`,`creator`,`import_config`,`source_info`,`source_type`,`offset`,`name`,`enable`,`user_import_config`)
VALUES (20,'2021-09-29 09:51:13','2021-09-29 11:51:19','{{x-empid}}','{{x-empid}}','[[{"__type":"sreworks_action","__id":"${id}","__label":"操作 审计","uuid":"${uuid}", "app_code":"${app_code}", "action_type":"${action_type}", "action_name":"${action_name}", "action_label":"${action_label}", "action_meta_data":"${action_meta_data}", "emp_id":"${emp_id}", "processor":"${processor}", "status":"${status}", "exec_data":"${exec_data}", "create_time":"${create_time}", "start_time":"${start_time}", "end_time":"${end_time}"}]]','{"startPeriod":0,"password":"bGuwsAWQM6K","port":3306,"isPartition":false,"host":"sreworks-mysql","interval":900,"db":"abm_paas_action","username":"root","sql":"select * from action;"}','mysqlTable','0','sreworks_action','true','{}');