      ...
      <Space>
        <Popover
          ...
          content={
            <JsonEditor
              key={reloadKey}
              json={Object.assign({}, nodeParams, { __currentUser__: undefined })}
              readOnly={true}
        ...
        <Popover
          ...
          content={
            <JsonEditor
              key={reloadKey}
              json={Object.assign({}, actionParams, { __currentUser__: undefined })}
              readOnly={true}
              style={{ height: '80vh', width: '50vw' }}
            />
          }
        ...
        {this.getEnvLabel() && (
          ...
          >
            <Alert
              ...
              description={
                <div>
                  非生产Prod环境，仅供测试开发使用！请前往
                  <a
                    onClick={(e) => {
                      let bizApp = util.getNewBizApp(),
                        app = window.location.hash.split('/')[1],
