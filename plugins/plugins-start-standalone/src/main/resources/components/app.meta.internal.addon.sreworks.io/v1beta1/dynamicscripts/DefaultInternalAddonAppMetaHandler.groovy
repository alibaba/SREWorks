 ...
 */
class DefaultInternalAddonAppMetaHandler implements ComponentHandler {

    /**
     * Handler 元信息
     */
    public static final String KIND = "COMPONENT"
    public static final String NAME = "app.meta.internal.addon.sreworks.io/v1beta1"
    ...
    String buildScriptName() {
        return "app.meta.internal.addon.sreworks.io/v1beta1/build"
    }
    ...
    String deployScriptName() {
        return "app.meta.internal.addon.sreworks.io/v1beta1/deploy"
    }
