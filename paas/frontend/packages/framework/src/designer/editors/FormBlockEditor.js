  ...
  buildingFormElements = () => {
    ...
    return (
      <Row style={{ marginTop: 12 }}>
        <Col span={12}>{[formChildrens[0], formChildrens[1]]}</Col>
      </Row>
    )
  }
...
export default class FormBlockEditor extends PureComponent {
  ...
  render() {
    let { parameterDefiner, reloadCount, openDrawer, showJson } = this.state,
        ...
        <Tabs
          ...
          tabBarExtraContent={
            <div className="feature-bar">
              <Button size="small" className="feature-button" onClick={this.showJson}>
                源码
              </Button>
        ...
        >
          ...
          <TabPane key="props" tab={<span>表单属性</span>}>
            <FormSettingForm
              ...
              onValuesChange={(changedField, allValue) => (this.formConfig = allValue)}
            />
          </TabPane>
        </Tabs>
        <Drawer
