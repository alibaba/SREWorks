export default {
    "id": "BizStackedAreaChart",
    "type": "BizStackedAreaChart",
    "name": "BizStackedAreaChart",
    "title": "堆叠面积图",
    "info": {
      "author": {
        "name": "",
      ...
      "description": "bizCharts图表库堆叠面积图",
      "links": [],
      "logos": {
        "large": "",
        "small": require("./icon.svg"),
        "fontClass":"BizStackedAreaChart"
      },
      "build": {
        "time": "",
        "repo": "",
      ...
      "updated": "",
      "version": "",
      "docs": "<a target='_blank' href='https://bizcharts.taobao.com/product/BizCharts4/category/77/page/119'>组件文档地址</a>",
    },
    "state": "",
    "latestVersion": "1.0",
    "configSchema": {
      ...
      "schema": {
        ...
        "properties": {
          ...
          "xField": {
            "description": "堆叠面积图图形在 x 方向（横向延伸）对应的数据字段名，一般对应一个连续字段",
            "title": "xField",
            "required": false,
            "type": "string",
            "x-component": "Input",
          ...
          "yField": {
            "description": "堆叠面积图在 y 方向对应的数据字段名，一般对应一个离散字段",
            "title": "yField",
            "required": false,
            "type": "string",
            "x-component": "Input",
          ...
          "stackField": {
            "description": "面积堆叠的字段名，通过该字段的值，面积图将会被分割为堆积的多个部分，通过颜色进行区分",
            "title": "stackField",
            "required": false,
            "type": "string",
            "x-component": "Input",
