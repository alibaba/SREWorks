    ...
    return (
      <div className="brief-layout-page-content">
        <PageHeader
            ...
            layout.showPageTitle !== false && (
              <div className="brief-header-title">
                ...
                <div style={{ display: 'grid', marginLeft: 14 }}>
                  ...
                  <p className="ant-page-header-heading-sub-title" style={{ fontWeight: 'normal' }}>
                    {description}
                  </p>
                </div>
              </div>
          ...
          footer={<TopMenus {...menuProps} assign={true} />}
        >
        ...
        <Layout
          ...
          style={{ height: `calc(100vh - 60px)`, padding: '0px 3px' }}
          id="__MAIN_CONTENT__"
        >
          <Content style={{ margin: '-8px' }}>{content}</Content>
        </Layout>
      </div>
    )
  }
