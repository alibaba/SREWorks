 ...
 */
@Slf4j
@Component("Check100InternalAddon")
public class Check100InternalAddon extends BaseAddon {

    @Getter
    private final String addonType = ComponentTypeEnum.INTERNAL_ADDON.toString();

    @Getter
    private final String addonId = "check";

    @Getter
    private final String addonVersion = "1.0.0";

    @Getter
    private final String addonLabel = "Internal-Check Addon";

    @Getter
    private final String addonDescription = "Internal-Check Addon";
